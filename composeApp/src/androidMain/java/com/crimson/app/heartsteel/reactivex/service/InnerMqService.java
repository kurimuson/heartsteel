package com.crimson.app.heartsteel.reactivex.service;

import com.crimson.app.heartsteel.reactivex.Topic;
import com.crimson.app.heartsteel.reactivex.client.InnerMqClient;
import com.crimson.app.heartsteel.reactivex.client.impl.NormalInnerMqClient;
...
public class InnerMqService {
    ...
    private final Random random = new Random(System.currentTimeMillis()); // 使用种子随机数生成唯一ID
    ...
    public InnerMqClient createClient() throws Exception {
        var id = CommonUtils.generateCharMixedExt(20) + "_" + this.random.nextInt();
